...
class WC_YouCanPay_Webhook_State {
	...
	const OPTION_LIVE_LAST_SUCCESS_AT     = 'wc_youcanpay_wh_last_success_at';
	const OPTION_LIVE_LAST_FAILURE_AT     = 'wc_youcanpay_wh_last_failure_at';
	const OPTION_LIVE_LAST_ERROR          = 'wc_youcanpay_wh_last_error';

	const OPTION_TEST_MONITORING_BEGAN_AT = 'wc_youcanpay_wh_test_monitor_began_at';
	const OPTION_TEST_LAST_SUCCESS_AT     = 'wc_youcanpay_wh_test_last_success_at';
	const OPTION_TEST_LAST_FAILURE_AT     = 'wc_youcanpay_wh_test_last_failure_at';
	const OPTION_TEST_LAST_ERROR          = 'wc_youcanpay_wh_test_last_error';
	...
	public static function get_testmode() {
		...
		return ( ! empty( $youcanpay_settings['testmode'] ) && 'yes' === $youcanpay_settings['testmode'] ) ? true : false;
	}
