...
class WC_YouCanPay_API {
	...
	public static function get_private_key() {
		if ( ! self::$private_key ) {
			...
			if ( isset( $options['sandbox_mode'], $options['production_private_key'], $options['sandbox_private_key'] ) ) {
				self::set_private_key( 'yes' === $options['sandbox_mode'] ? $options['sandbox_private_key'] : $options['production_private_key'] );
			}
		}
	...
	public static function get_public_key() {
		if ( ! self::$public_key ) {
			...
			if ( isset( $options['sandbox_mode'], $options['production_public_key'], $options['sandbox_public_key'] ) ) {
				self::set_public_key( 'yes' === $options['sandbox_mode'] ? $options['sandbox_public_key'] : $options['production_public_key'] );
			}
		}
