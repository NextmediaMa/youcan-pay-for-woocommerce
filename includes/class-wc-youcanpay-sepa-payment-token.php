...
/**
 * WooCommerce YouCan Pay SEPA Direct Debit Payment Token.
 *
 * Representation of a payment token for SEPA.
 *
 * @class    WC_YouCan_Pay_Token_SEPA
 * @version  4.0.0
 * @since    4.0.0
 */
class WC_YouCan_Pay_Token_SEPA extends WC_Payment_Token {
	...
	/**
	 * Set YouCan Pay payment method type.
	 *
	...
	/**
	 * Returns YouCan Pay payment method type.
	 *
	 * @param string $context What the value is for. Valid values are view and edit.
