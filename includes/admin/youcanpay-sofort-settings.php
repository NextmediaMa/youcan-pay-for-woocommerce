...
return apply_filters(
	...
	[
		'geo_target'  => [
			'description' => __( 'Customer Geography: Germany, Austria', 'woocommerce-gateway-youcanpay' ),
			'type'        => 'title',
		],
		'guide'       => [
			'description' => __( '<a href="https://youcanpay.com/payments/payment-methods-guide#sofort" target="_blank">Payment Method Guide</a>', 'woocommerce-gateway-youcanpay' ),
			'type'        => 'title',
		],
		'activation'  => [
		...
		'enabled'     => [
			...
			'label'       => __( 'Enable YouCan Pay SOFORT', 'woocommerce-gateway-youcanpay' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		],
		'title'       => [
			...
			'default'     => __( 'SOFORT', 'woocommerce-gateway-youcanpay' ),
			'desc_tip'    => true,
		],
		'description' => [
			...
			'default'     => __( 'You will be redirected to SOFORT.', 'woocommerce-gateway-youcanpay' ),
			'desc_tip'    => true,
		],
		'webhook'     => [
