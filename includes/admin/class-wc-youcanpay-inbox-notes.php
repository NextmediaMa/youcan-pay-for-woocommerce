 ...
 * @since 4.5.4
 */
class WC_YouCanPay_Inbox_Notes {
	const SUCCESS_NOTE_NAME = 'youcanpay-apple-pay-marketing-guide-holiday-2020';
	const FAILURE_NOTE_NAME = 'youcanpay-apple-pay-domain-verification-needed';

	const POST_SETUP_SUCCESS_ACTION    = 'wc_youcanpay_apple_pay_post_setup_success';
	const CAMPAIGN_2020_CLEANUP_ACTION = 'wc_youcanpay_apple_pay_2020_cleanup';
	...
	public static function create_upe_availability_note() {
		...
		WC_YouCanPay_UPE_Availability_Note::init();
	}
	...
	public static function notify_on_apple_pay_domain_verification( $verification_complete ) {
		$admin_notes_class = WC_YouCanPay_Woo_Compat_Utils::get_notes_class();
