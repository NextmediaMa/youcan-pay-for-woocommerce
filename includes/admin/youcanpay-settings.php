...
$youcanpay_settings = apply_filters(
	...
	[
		...
		'payment_request_button_label' => [
			...
			'type'        => 'text',
			'description' => __( 'Enter the custom text you would like the button to have.', 'youcan-pay' ),
		...
		'logging'                      => [
			...
			'type'        => 'checkbox',
			'description' => __( 'Save debug messages to the WooCommerce System Status log.', 'youcan-pay' ),
			'default'     => 'no',
			'desc_tip'    => true,
		],
	]
