<?php
/**
 * Class WC_REST_YouCanPay_Settings_Controller
 */
 ...
 */
class WC_REST_YouCanPay_Settings_Controller extends WC_YouCanPay_REST_Base_Controller {
	 ...
	 * @var string
	 */
	protected $rest_base = 'wc_youcanpay/settings';

	/**
	 * YouCanPay payment gateway.
	 *
	 ...
	 * Constructor.
	 *
	 * @param WC_Gateway_YouCanPay $gateway YouCanPay payment gateway.
	 */
	public function __construct( WC_Gateway_YouCanPay $gateway ) {
	...
	public function get_settings() {
		return new WP_REST_Response(
			[
				/* Settings > General */
				'is_youcanpay_enabled'                     => $this->gateway->is_enabled(),
	...
	public function update_settings( WP_REST_Request $request ) {
		/* Settings > General */
		$this->update_is_youcanpay_enabled( $request );
	...
	/**
	 * Updates YouCanPay enabled status.
	 *
	 * @param WP_REST_Request $request Request object.
	 */
	private function update_is_youcanpay_enabled( WP_REST_Request $request ) {
		$is_youcanpay_enabled = $request->get_param( 'is_youcanpay_enabled' );

		if ( null === $is_youcanpay_enabled ) {
			return;
		}

		if ( $is_youcanpay_enabled ) {
			$this->gateway->enable();
		} else {
