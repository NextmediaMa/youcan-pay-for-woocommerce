<?php
/**
 * Class WC_YouCanPay_REST_UPE_Flag_Toggle_Controller
 */
 ...
 */
class WC_YouCanPay_REST_UPE_Flag_Toggle_Controller extends WC_YouCanPay_REST_Base_Controller {
	/**
	 * Endpoint path.
	 *
	 * @var string
	 */
	protected $rest_base = 'wc_youcanpay/upe_flag_toggle';
	...
	public function set_flag( WP_REST_Request $request ) {
		...
		$settings[ WC_YouCanPay_Feature_Flags::UPE_CHECKOUT_FEATURE_ATTRIBUTE_NAME ] = $is_upe_enabled ? 'yes' : 'disabled';

		update_option( 'woocommerce_youcanpay_settings', $settings );
