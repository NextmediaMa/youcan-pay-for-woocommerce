 ...
 * @since 5.5.0
 */
class WC_YouCanPay_UPE_Compatibility_Controller {
	...
	public function add_inbox_note() {
		...
		if ( WC_YouCanPay_UPE_Compatibility::are_inbox_notes_supported() ) {
			...
			WC_YouCanPay_UPE_Compatibility_Note::init();
		}
	}
	...
	public function add_compatibility_notice() {
		 ...
		 * - If WC is not supported -> construct message saying "YouCan Pay requires WooCommerce 5.4 or greater to be installed and active. Your version of WooCommerce [X.X] is no longer be supported"
		 * - If WP is not supported -> construct message saying "YouCanPay requires WordPress 5.6 or greater. Your version of WordPress [X.X] is no longer be supported"
		 * - If WC & WP are both not supported -> construct message saying "YouCanPay requires WordPress 5.6 or greater and WooCommerce 5.4 or greater to be installed and active. Your versions of WordPress [X.X] and WooCommerce [X.X] are no longer be supported"
		 */
		$unsatisfied_requirements = array_filter(
			[
				...
				[
					...
					'is_supported' => version_compare( $this->get_wc_version(), WC_YouCanPay_UPE_Compatibility::MIN_WC_VERSION, '>=' ),
					'message'      => sprintf(
	...
	private function show_current_compatibility_notice( $unsatisfied_requirements ) {
		 ...
		 * The following might be hard to read, but here's what I'm trying to do:
		 * - If WP and WC are both supported -> nothing to do
		 * - If WC is not supported -> construct message saying "WooCommerce YouCanPay requires WooCommerce 5.4 or greater to be installed and active. Your version of WooCommerce [X.X] is no longer supported"
		 * - If WP is not supported -> construct message saying "WooCommerce YouCanPay requires WordPress 5.6 or greater. Your version of WordPress [X.X] is no longer supported"
		 * - If WC & WP are both not supported -> construct message saying "WooCommerce YouCanPay requires WordPress 5.6 or greater and WooCommerce 5.4 or greater to be installed and active. Your versions of WordPress [X.X] and WooCommerce [X.X] are no longer supported"
		 */
	...
	private function show_upe_settings_compatibility_notice( $unsatisfied_requirements ) {
		 ...
		 * The following might be hard to read, but here's what I'm trying to do:
		 * - If WP and WC are both supported -> nothing to do
		 * - If WC is not supported -> construct message saying "YouCanPay will require WooCommerce 5.4 or greater to be installed and active. Your version of WooCommerce [X.X] will no longer be supported"
		 * - If WP is not supported -> construct message saying "YouCanPay will require WordPress 5.6 or greater. Your version of WordPress [X.X] will no longer be supported"
		 * - If WC & WP are both not supported -> construct message saying "YouCanPay will require WordPress 5.6 or greater and WooCommerce 5.4 or greater to be installed and active. Your versions of WordPress [X.X] and WooCommerce [X.X] will no longer be supported"
		 */
		$unsatisfied_requirements_message = $this->get_unsatisfied_requirements_message( $unsatisfied_requirements );
