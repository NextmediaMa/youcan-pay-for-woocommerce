...
return apply_filters(
	...
	[
		...
		'enabled'     => [
			...
			'label'       => __( 'Enable YouCan Pay Standalone', 'woocommerce-youcan-pay' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		],
		'title'       => [
			...
			'default'     => __( 'YouCan Pay Standalone', 'woocommerce-youcan-pay' ),
			'desc_tip'    => true,
		],
		'description' => [
			...
			'default'     => __( 'You will be redirected to YouCan Pay.', 'woocommerce-youcan-pay' ),
			'desc_tip'    => true,
		],
	]
);
