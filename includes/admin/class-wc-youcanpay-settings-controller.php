...
class WC_YouCanPay_Settings_Controller {
	...
	public function admin_scripts( $hook_suffix ) {
		...
		wp_register_script( 'woocommerce_youcanpay_admin', plugins_url( sprintf('/assets/js/youcanpay-admin%s.js', $suffix), WC_YOUCAN_PAY_MAIN_FILE ), [], WC_YOUCAN_PAY_VERSION, true );
		wp_register_style(
