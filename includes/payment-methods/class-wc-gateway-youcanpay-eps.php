 ...
 * @since 4.1.0
 */
class WC_Gateway_YouCanPay_Eps extends WC_YouCanPay_Payment_Gateway {

	const ID = 'youcanpay_eps';
	...
	public function __construct() {
		$this->id           = self::ID;
		$this->method_title = __( 'YouCan Pay EPS', 'woocommerce-gateway-youcanpay' );
		/* translators: link */
	...
	public function get_supported_currency() {
		return apply_filters(
			'wc_youcanpay_eps_supported_currencies',
			[
				'EUR',
			]
		);
	...
	public function init_form_fields() {
		$this->form_fields = require WC_YOUCAN_PAY_PLUGIN_PATH . '/includes/admin/youcanpay-eps-settings.php';
	}
	...
	public function process_payment( $order_id, $retry = true, $force_save_source = false ) {
		try {
			...
			WC_YouCanPay_Logger::log( 'Info: Redirecting to EPS...' );
