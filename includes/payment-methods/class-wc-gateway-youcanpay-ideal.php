 ...
 * @since 4.0.0
 */
class WC_Gateway_YouCanPay_Ideal extends WC_YouCanPay_Payment_Gateway {

	const ID = 'youcanpay_ideal';
	...
	public function __construct() {
		$this->id           = self::ID;
		$this->method_title = __( 'YouCanPay iDeal', 'woocommerce-gateway-youcanpay' );
		/* translators: link */
	...
	public function get_supported_currency() {
		return apply_filters(
			'wc_youcanpay_ideal_supported_currencies',
			[
				'EUR',
			]
		);
	...
	public function init_form_fields() {
		$this->form_fields = require WC_YOUCAN_PAY_PLUGIN_PATH . '/includes/admin/youcanpay-ideal-settings.php';
	}
	...
	public function payment_fields() {
		...
		echo '<div
			id="youcanpay-ideal-payment-data"
	...
	public function create_source( $order ) {
		...
		WC_YouCanPay_Logger::log( 'Info: Begin creating iDeal source' );

		return WC_YouCanPay_API::request( apply_filters( 'wc_youcanpay_ideal_source', $post_data, $order ), 'sources' );
	}
	...
	public function process_payment( $order_id, $retry = true, $force_save_source = false ) {
		try {
			...
			WC_YouCanPay_Logger::log( 'Info: Redirecting to iDeal...' );
