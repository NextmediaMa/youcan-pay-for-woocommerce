 ...
 * @since 4.0.0
 */
class WC_Gateway_YouCanPay_Sofort extends WC_YouCanPay_Payment_Gateway {

	const ID = 'youcanpay_sofort';
	...
	public function __construct() {
		$this->id           = 'youcanpay_sofort';
		$this->method_title = __( 'YouCan Pay SOFORT', 'woocommerce-gateway-youcanpay' );
		/* translators: link */
	...
	public function get_supported_currency() {
		return apply_filters(
			'wc_youcanpay_sofort_supported_currencies',
			[
				'EUR',
			]
		);
	...
	public function init_form_fields() {
		$this->form_fields = require WC_YOUCAN_PAY_PLUGIN_PATH . '/includes/admin/youcanpay-sofort-settings.php';
	}
	...
	public function payment_fields() {
		...
		echo '<div
			id="youcanpay-sofort-payment-data"
	...
	public function create_source( $order ) {
		...
		return WC_YouCanPay_API::request( apply_filters( 'wc_youcanpay_sofort_source', $post_data, $order ), 'sources' );
	}
	...
	public function process_payment( $order_id, $retry = true, $force_save_source = false ) {
		try {
			...
			WC_YouCanPay_Logger::log( 'Info: Redirecting to SOFORT...' );
