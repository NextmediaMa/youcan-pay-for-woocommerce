 ...
 *
 * @extends WC_YouCanPay_Email_Failed_Authentication
 */
class WC_YouCanPay_Email_Failed_Preorder_Authentication extends WC_YouCanPay_Email_Failed_Authentication {
	/**
