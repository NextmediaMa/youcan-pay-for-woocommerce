...
/**
 * YouCanPay Connect base REST controller class.
 */
abstract class WC_YouCanPay_Connect_REST_Controller extends WP_REST_Controller {
	...
	/**
	 * Registers rest routes for youcanpay connect functionality
	 */
